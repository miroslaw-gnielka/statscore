...
class GildedRoseTest extends TestCase
{
     ...
     */
    public function update_quality($name, $sellIn, $quality, $expectedSellIn, $expectedQuality): void
    {
        //with
        ...
        $gildedRose = new GildedRose($itemsCollection);
